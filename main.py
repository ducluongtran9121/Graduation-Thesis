...
if __name__ == "__main__":
    ...
    average_config = configs[7]["average_config"]
    ...
    central_server = Server(writer, model_config, global_config, data_config, init_config, fed_config, optim_config, average_config)
